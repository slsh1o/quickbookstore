    ...
    <div class="form-group mt-3 col-md-6">
        <form action="${path}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" id="description" rows="4" maxlength="2000"
                          <#if !isEditForm>placeholder="Enter description" </#if>
                ><#if isEditForm>${book.description}</#if>
                </textarea>
            </div>
            <div class="form-group">
                <label>Genres</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="price" id="price" type="number" min="1" step="0.01"
